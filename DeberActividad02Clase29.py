#Deber Pregunta: Modifica el sistema de cajero automático para incluir una nueva opción en el menú que permita al usuario 
#cambiar su PIN de seguridad. El sistema debe solicitar el PIN actual antes de permitir el cambio.

# Variables globales
saldo = 1000.0  # El saldo inicial en la cuenta
historial = []  # Lista para guardar las transacciones realizadas
pin = "1234"    # PIN inicial de seguridad
...
def cambiar_pin():
    ...
    if nuevo_pin == confirmacion_pin:
        pin = nuevo_pin
        print("Tu PIN ha sido cambiado con éxito.")
    else:
        print("Los PINs no coinciden. Inténtalo nuevamente.")
